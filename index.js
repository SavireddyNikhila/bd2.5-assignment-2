...
function sortStocksByPricingInAscendingOrder(stock1, stock2) {
  return stock1.price - stock2.price;
}

function sortStocksByPricingInDescendingOrder(stock1, stock2) {
...
app.get('/stocks/sort/pricing', (req, res) => {
  ...
  if (pricing === 'low-to-high') {
    sortedStocks = stocksCopy.sort(sortStocksByPricingInAscendingOrder);
  } else if (pricing === 'high-to-low') {
    sortedStocks = stocksCopy.sort(sortStocksByPricingInDescendingOrder);
  }
  res.json({ stocks: sortedStocks });
});

function sortStocksByGrowthInAscendingOrder(stock1, stock2) {
  return stock1.growth - stock2.growth;
}

function sortStocksByGrowthInDescendingOrder(stock1, stock2) {
...
app.get('/stocks/sort/growth', (req, res) => {
  ...
  if (growth === 'low-to-high') {
    sortedStocks = stocksCopy.sort(sortStocksByGrowthInAscendingOrder);
  } else if (growth === 'high-to-low') {
    sortedStocks = stocksCopy.sort(sortStocksByGrowthInDescendingOrder);
  }
  res.json({ stocks: sortedStocks });
});
